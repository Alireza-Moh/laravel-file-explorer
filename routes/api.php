...
Route::group([
    ...
    Route::post('disks/{diskName}/dirs/{dirName}/new-file', [FileController::class, 'createFile'])->name("fx.file-create");
    Route::post('disks/{diskName}/dirs/{dirName}/new-dir', [DirController::class, 'createDir'])->name("fx.dir-create");
    Route::post('disks/{diskName}/files/upload', [FileController::class, 'uploadFiles'])->name("fx.file-upload");
    Route::post('disks/{diskName}/files/download', [FileController::class, 'downloadFile'])->name("fx.file-download");
    Route::post('disks/{diskName}/dirs/{dirName}', [DirController::class, 'loadDirItems'])->name("fx.load-dir-items");

    Route::put('disks/{diskName}/files/{dirName}', [FileController::class, 'renameFile'])->name("fx.file-rename");
    Route::put('disks/{diskName}/dirs/{dirName}', [DirController::class, 'renameDir'])->name("fx.dir-rename");

    Route::delete('disks/{diskName}/files/delete', [FileController::class, 'deleteFile'])->name("fx.file-delete");
