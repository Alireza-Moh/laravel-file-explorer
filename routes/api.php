...
Route::group([
    ...
    Route::post('disks/{diskName}/items/{itemName}', [ItemController::class, 'getContent'])->name("fx.get-item-content");
    ...
    Route::put('changes/disks/{diskName}/items/{itemName}', [ItemController::class, 'updateContent'])->name("fx.update-item-content");
